...
public class DetailStaffDialog extends javax.swing.JDialog {
    private int maNhanVien;
    
    public DetailStaffDialog(java.awt.Frame parent, boolean modal, int maNhanVien) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        viTriComboBox.setEditable(true);
        ...
        viTriComboBox.setFocusable(false);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
        gridBagConstraints.gridy = 3;
        gridBagConstraints.gridwidth = 2;
        ...
        trangThaiComboBox.setEditable(true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DetailStaffDialog dialog = new DetailStaffDialog(new javax.swing.JFrame(), true,-1);
