...
public class EditStaffDialog extends javax.swing.JDialog {
    private int maNhanVien;
    
    public EditStaffDialog(java.awt.Frame parent, boolean modal, int maNhanVien) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CHỈNH SỬA THÔNG TIN NHÂN VIÊN");
        ...
        viTriLabel.setFont(new java.awt.Font("Roboto", 0, 12)); // NOI18N
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(20, 10, 5, 20);
        dialogInputSection.add(viTriLabel, gridBagConstraints);

        viTriComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Quản lí", "Nhân viên", "Đầu bếp" }));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
        gridBagConstraints.gridy = 3;
        gridBagConstraints.gridwidth = 2;
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(5, 10, 10, 10);
        dialogInputSection.add(viTriComboBox, gridBagConstraints);
    ...
    private void getStaffInformation(){
        ...
        NhanVien currentNhanVien = nhanVienController.getNhanVien(maNhanVien);
        
        hoVaTenTextField.setText(currentNhanVien.getHoVaTen());
        tenDangNhapTextField.setText(currentNhanVien.getUsername());
        matKhauTextField.setText(currentNhanVien.getMatKhau());
        emailTextField.setText(currentNhanVien.getEmail());
        viTriComboBox.setSelectedItem(currentNhanVien.getViTri());
        trangThaiComboBox.setSelectedItem(currentNhanVien.isTrangThaiNV()?"Hoạt động" : "Vắng mặt");
    }
    ...
    private void editButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editButtonActionPerformed
        ...
        String viTri = (String)viTriComboBox.getSelectedItem();
        String trangThaiString = (String)trangThaiComboBox.getSelectedItem();
        int trangThai = trangThaiString.equals("Hoạt động") ? 1 : 0;
        
        
        NhanVienController nhanVienController = new NhanVienController();
        boolean result = nhanVienController.updateNhanVienModel(maNhanVien, hoVaTen, tenDangNhap, matKhau, email, viTri, trangThai);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EditStaffDialog dialog = new EditStaffDialog(new javax.swing.JFrame(), true,-1);
