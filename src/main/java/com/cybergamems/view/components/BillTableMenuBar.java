...
public class BillTableMenuBar extends javax.swing.JPanel {

    public BillTableMenuBar() {
    ...
    public JButton getPayTableDataButton() {
        return payTableDataButton;
    }
    ...
    private void initComponents() {
        ...
        payTableDataButton.setBackground(new java.awt.Color(60, 63, 65));
        payTableDataButton.setFont(new java.awt.Font("Roboto", 1, 12)); // NOI18N
        payTableDataButton.setText("Thanh toán");
        payTableDataButton.setMaximumSize(new java.awt.Dimension(80, 40));
        payTableDataButton.setMinimumSize(new java.awt.Dimension(80, 40));
        payTableDataButton.setPreferredSize(new java.awt.Dimension(80, 40));
        payTableDataButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                payTableDataButtonActionPerformed(evt);
            }
        });
        ...
        tableFunctionBarPanel.add(payTableDataButton, gridBagConstraints);
    ...
    private void payTableDataButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_payTableDataButtonActionPerformed
        // TODO add your handling code here:
