...
public class DashboardMenu extends javax.swing.JPanel {
    ...
    private void initData(){
        dashboardMenuList1.addItem(new DashboardMenuModel("home-icon","Trang chủ",DashboardMenuModel.menuType.MENU));
        dashboardMenuList1.addItem(new DashboardMenuModel("computer-icon","Phòng máy",DashboardMenuModel.menuType.MENU));
        dashboardMenuList1.addItem(new DashboardMenuModel("client-icon","Khách hàng",DashboardMenuModel.menuType.MENU));
        dashboardMenuList1.addItem(new DashboardMenuModel("services-icon","Dịch vụ",DashboardMenuModel.menuType.MENU));
        dashboardMenuList1.addItem(new DashboardMenuModel("staff-icon","Nhân viên",DashboardMenuModel.menuType.MENU));
        dashboardMenuList1.addItem(new DashboardMenuModel("statistic-icon","Thống kê",DashboardMenuModel.menuType.MENU));
        dashboardMenuList1.addItem(new DashboardMenuModel("bill-icon","Hóa đơn",DashboardMenuModel.menuType.MENU));
        dashboardMenuList1.addItem(new DashboardMenuModel("account-icon","Tài khoản",DashboardMenuModel.menuType.MENU));
        dashboardMenuList1.addItem(new DashboardMenuModel("exit-icon","Đăng xuất",DashboardMenuModel.menuType.MENU));
        dashboardMenuList1.addItem(new DashboardMenuModel("","",DashboardMenuModel.menuType.EMPTY));
    }
